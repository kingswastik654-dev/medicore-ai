...
export default function ConsultPage() {
  ...
  return (
    <AppShell title="Consult">
      ...
      {message && <div className="rounded-md bg-green-50 border border-green-200 px-3 py-2 text-sm text-green-700 mb-4">{message}</div>}
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="space-y-4 xl:col-span-2">
            <div className="card">
              ...
              <textarea className="input min-h-24 font-mono text-xs" placeholder={"Patient: I have fever since two days…\nDoctor: Chest examination clear."}
